...
class OuterSplitLoader:
    ...
    def load_model(self) -> Any:
        ...
        return joblib.load(self.model_dir / "model.joblib")
    ...
    def load_predictions(self) -> pd.DataFrame:
        """Load predictions.parquet from result_dir with optional filtering by module.
    ...
    def load_feature_importance(self) -> pd.DataFrame:
        """Load feature_importances.parquet from result_dir with optional filtering.
