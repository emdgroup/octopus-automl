...
See [Use Own Hyperparameters](../examples/use_own_hyperparameters.md) for a full example.
...
- [Use Own Hyperparameters](../examples/use_own_hyperparameters.md): Shows how to define your own hyperparameter search ranges instead of using the defaults.
- [Multi-Step Regression](../examples/wf_multi_step_regression.md): Chains Octo and MRMR into a multi-step pipeline that selects features before final model training.
