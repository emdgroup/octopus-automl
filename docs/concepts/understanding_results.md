...
3. **Feature importances** — which features matter most? Are they scientifically
   plausible?
4. **Diagnostics** — use the [Analysis & Diagnostics](../diagnostics/)
   notebooks for confusion matrices, ROC curves, prediction-vs-truth plots,
   and Optuna hyperparameter insights.
